...
we need two methods for controlling the monad, the convert and side-effect methods, and the abstract functions passed into the convert and side-effect methods.
